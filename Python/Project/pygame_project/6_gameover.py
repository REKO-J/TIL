...
total_time = 100
start_ticts = pygame.time.get_ticks()  # 시작 시간 정의
...
while running:
    ...
    for ball_idx, ball_val in enumerate(balls):
        ...
        break         # 안쪽 for문에서 break를 만나면 여기로 진입 가능. 2중 for문을 한 번에 탈출
    ...
    # 경과 시간 계산
    elapsed_time = (pygame.time.get_ticks() - start_ticts) / 1000  # ms -> s
