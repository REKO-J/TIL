...
# 배경 이미지 불러오기
backgoround = pygame.image.load("C:/PythonWorkspace/pygame_basic/background.png")
...
enemy_x_pos = random.randrange(70, screen_width-70)
enemy_y_pos = 0
...
while running:
    ...
    enemy_y_pos += random.randrange(10, 16)
    ...
    # 5. 화면에 그리기
    screen.blit(backgoround, (0, 0))                            # 배경 그리기
    screen.blit(character, (character_x_pos, character_y_pos))  # 캐릭터 그리기
    screen.blit(enemy, (enemy_x_pos, enemy_y_pos))              # 적(enemy) 그리기
